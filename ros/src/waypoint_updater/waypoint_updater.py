...
class WaypointUpdater(object):
    def __init__(self):
        ...
        # rospy.Subscriber('/obstacle_waypoints', Lane, self.obstacle_waypoints_cb)
    ...
    def loop(self):
        ...
        while not rospy.is_shutdown():
            if self.pose and self.base_waypoints and  self.wp_tree:
    ...
    def waypoints_cb(self, waypoints):
        ...
        if not self.waypoints_2d:
            ...
            self.wp_tree = KDTree(self.waypoints_2d)
